...
class StsLoginFinishReplyPacket {
public:
  StsLoginFinishReplyPacket() = default;
  StsLoginFinishReplyPacket(const std::vector<std::uint8_t> &data) noexcept;
  ...
  common::GWUUID xml_content_user_id;
  std::uint32_t xml_content_user_center;
  std::string xml_content_user_name;
  common::GWUUID xml_content_resume_token;
