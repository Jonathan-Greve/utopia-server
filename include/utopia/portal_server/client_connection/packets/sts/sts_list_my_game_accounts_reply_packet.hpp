...
class StsListMyGameAccountsReplyPacket {
public:
  StsListMyGameAccountsReplyPacket() = default;
  StsListMyGameAccountsReplyPacket(
  ...
  std::string xml_content_alias;
  std::string xml_content_created;
